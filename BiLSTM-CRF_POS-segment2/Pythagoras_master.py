...
#import sys
import random
from process.template import DataSet,Vocabulary,IndexSet,BatchBucket,PretrainEmbed
...
#       ******************  2.model train  ************************************
        ...
        self.models.save_models_params_display()
...
#        sys.stdout = open('config.save','w',encoding='utf-8')
#        self.params.__show__()
#        sys.stdout.close()
...
#            random.shuffle(indexes)
            ...
            for updateIter in range(batchBlock):
                ...
                self.models.forward_all(batch_instance,iter_num=updateIter)
            ...
            self.models.save_best_models(dev_rate,test_rate,iter)
