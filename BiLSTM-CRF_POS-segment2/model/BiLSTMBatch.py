...
#==============================================================================
#   以下部分为独立的 BiLSTM 标注器，后面不加CRF解码器时使用
#==============================================================================
#	def forward(self,data):#**
#        label_mat=data.batch_labels#b,s
#        seq_length=label_mat.size(1)
#        batch=data.batch_size
#        label_mat=label_mat.view(batch*seq_length)
#
#        word_mat=data.batch_words
#        senSize=word_mat.size(1)
#        word_input=self.embed(word_mat)#b,s,l
...
#        lstmHidden=self.init_hidden(batch)
#        lstmOutput,_=self.lstm(word_dropout.view(batch,senSize,-1),lstmHidden)#
#        labelscores=self.linear(lstmOutput)#b,s,l
#        
#        softmax=nn.Softmax(dim=1)
#        labelscores=softmax(labelscores.view(batch*seq_length,self.label_size))#b*s,l
#        
#        cross_entropy=nn.CrossEntropyLoss()
#        
#        loss=cross_entropy(labelscores,label_mat)
#        return loss
#    
...
#        labelscores=self.linear(lstmOutput)
#        
#        max_score, max_index = torch.max(labelscores,dim=2)
##        print(max_index)
#        return max_index.transpose(0,1)
